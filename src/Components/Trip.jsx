            ...
            <div className="tripcard-container">
              ...
              Add to Favorites
                ...
                {/* <div className="tripcard">
                    <TripData 
                        image={Trip6}
                        heading="The feast of Santa Lucia is a journey through popular traditions, from Syracuse to Venice"
                        text="She is patron saint of her home town, Syracuse, and is celebrated with an impressive procession. While in the North, Lucia is a female Father Christmas. A trip during this period provides the excitement of contact with ancient popular rituals, still deeply felt today."
                    />
                </div> */}
            </div>
